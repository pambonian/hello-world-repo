...
const displayPostList = postList.map((p, idx) => {
    return (
        <div className="card">
            <div className="header">
                <div className="media">
                    ...
                    <div className="media-content">
                        <p className="title is-4">{p.message}</p>
                        <p className="subtitle is-6">{p.author}</p>
                    </div>
                </div>
            </div>
                        ...
                        <div className="card">
                            <div className="header">
                                <div className="media">
                                    ...
                                    <div className="media-content">
                                        <p className="title is-4">{post.message}</p>
                        ...
                        <div className="card">
                            <div className="header">
                                <div className="media">
                                    ...
                                    <div className="media-content">
                                        <p className="title is-4">J{post.message}</p>
                                        <p className="subtitle is-6">{post.author}</p>
                                    </div>
                                </div>
                            </div>
